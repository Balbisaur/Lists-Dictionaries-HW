...
print(sorted_array)
 # this is my first attempt to merge two lists, it works when the numbers in each list are in ascending order. besides that if it was pre-sorted like [1,3,5] [2,4,6],
